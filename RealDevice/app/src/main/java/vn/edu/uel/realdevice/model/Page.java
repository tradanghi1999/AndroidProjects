package vn.edu.uel.realdevice.model;
...
public class Page {
    ...
    private static Page getHomepage(Context context)
    {
        ...
        String json = parseJSONToString("page_config.json",context);
        Page mPage = gson.fromJson(json, Page.class);
        return mPage;
    }
    private static String parseJSONToString(String s,Context context) {
        String json = null;
        try {
